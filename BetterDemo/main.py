...
import PrimaryControls as PrmryCntrlAr
import Model.ImageArea as ImgAr


class MainWindow(qtw.QMainWindow):

    openFiles = []
    #primaryControlArea = PrmryCntrlAr.PrimaryControlArea()
    #imageArea = ImgAr.ImageArea()
    ...
    def __init__(self):#telling main window to init 
        ...
        self.mainControls(mainBox) # FIXME need to refactor into an object with methods for interaction
        self.imageArea(mainBox) # FIXME need to refactor into an object with methods for interaction
    ...
    def canvas(self, canvasContainer):
        print("unimplemented")
        scene = qtw.QGraphicsScene(0, 0, 400, 200)
        pen = qtw.QGraphicsItem()
